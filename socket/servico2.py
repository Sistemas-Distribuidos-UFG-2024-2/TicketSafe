...
HOST = '127.0.0.3'  # Endereço IP do servidor (localhost)
PORT = 65433        # Porta usada pelo servidor
    ...
    while True:
        try:
            with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
                ...
                print(f"[SERVIDOR 2] - Sinal de atividade enviado ao checador de saúde: {mensagem}")
