...
* **RF005**: O sistema deve notificar os usuários sobre o status de suas reservas (confirmação, expiração, etc.).


3.3 *Gerenciamento de Eventos*

* **RF006**: O sistema deve permitir que os organizadores criem e gerenciem eventos, definindo o número de ingressos disponíveis, categorias e preços.  
...
3.5 *Backup e Recuperação Distribuídos*
...
* **RNF005**: O sistema deve garantir a segurança dos dados dos usuários e das transações.  
* **RNF006**: O sistema deve implementar autenticação e autorização para usuários e administradores.
...
#### **5\. Algoritmos, Tecnologias e Arquitetura**


5.1 *Arquitetura Baseada em Microsserviços*
...
5.4 *Backup e Recuperação Distribuídos*
...
#### **6\. Considerações sobre Sistemas Distribuídos**

6.1 *Consistência Eventual*
...
6.2 *Particionamento e Tolerância a Falhas*
...
6.3 *Replicações de Serviços e Dados*
